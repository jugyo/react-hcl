...
// Source: https://developer.hashicorp.com/terraform/providers/hashicorp/aws/latest/docs/resources/vpc_security_group_ingress_rule
export const awsVpcSecurityGroupIngressRuleResourceSchema: TerraformTypeSchema =
  {
    kind: "resource",
